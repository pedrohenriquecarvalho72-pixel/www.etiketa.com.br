...
import {
  ...
  ArrowRight, ArrowLeft, CheckCircle2, Phone, Mail,
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, fontSize: 14, color: "rgba(250,246,236,0.85)" }}>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 4 }}>
              <span aria-label="Instagram" style={{ fontWeight: 800, fontSize: 14 }}>ig</span>
              <span aria-label="Facebook" style={{ fontWeight: 800, fontSize: 14 }}>f</span>
            </div>
          </div>
        </div>
      </div>
